let gl: WebGL2Context | null = null;
...
function createShader(gl: WebGL2Context, type: number, source: string) {
...
function createProgram(gl: WebGL2Context, vsSource: string, fsSource: string) {
